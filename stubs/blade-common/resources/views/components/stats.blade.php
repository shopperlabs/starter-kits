<x-container class="py-10 sm:py-14 lg:py-16">
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div class="flex items-center">
            <x-untitledui-truck class="size-8 text-black" aria-hidden="true" stroke-width="1.5" />
            <div class="ml-4">
        ...
        <div class="flex items-center">
            <x-untitledui-face-smile class="size-8 text-black" aria-hidden="true" stroke-width="1.5" />
            <div class="ml-4">
        ...
        <div class="flex items-center">
            <x-heroicon-o-shield-check class="size-8 text-black" aria-hidden="true" stroke-width="1.5" />
            <div class="ml-4">
        ...
        <div class="flex items-center">
            <x-heroicon-o-tag class="size-8 text-black" aria-hidden="true" stroke-width="1.5" />
            <div class="ml-4">
