    ...
    <x-container>
        <div class="grid grid-cols-1 gap-8 py-10 lg:grid-cols-3 lg:py-20">
            <div class="lg:max-w-sm">
                <h3 class="text-sm font-medium text-gray-900">
                    <x-brand
                        class="size-14 lg:size-20"
                        pattern="#3f3f46"
                        square="#71717a"
                    />
                </h3>
                <p class="mt-10 text-white text-sm leading-6">
        ...
        <div class="pb-10 lg:flex lg:items-center lg:justify-between lg:pb-20">
            <div class="space-y-4 lg:space-y-0 lg:flex lg:flex-1 lg:gap-10">
                <div>
                    <dl class="font-heading text-sm font-medium uppercase leading-4 tracking-wider text-gray-300 underline">
                        {{ __('Contact') }}
                    </dl>
                    <ul class="mt-4 flex flex-col space-y-1 text-sm text-gray-300">
                ...
                <div>
                    ...
                    <dt class="mt-4 text-sm leading-5 text-white">
        ...
        <div class="flex flex-col items-center border-t border-gray-800 py-8 sm:flex-row sm:justify-between lg:py-10">
            ...
            <div class="mt-5 divide-x divide-gray-700 sm:mt-0">
                <x-link href="#" class="inline-flex px-3 text-sm leading-5 text-white hover:underline">
                    {{ __('Privacy') }}
                </x-link>
                <x-link href="#" class="inline-flex px-3 text-sm leading-5 text-white hover:underline">
                    {{ __('Terms of use') }}
